...
hl.config({
	general = {
		...
		col = {
			active_border = "rgba(a8adb0cc)",
			inactive_border = "rgba(343a3c99)",
		},
...
hl.animation({ leaf = "border", enabled = true, speed = 0.9, bezier = "easeOutQuint" })
hl.animation({ leaf = "windows", enabled = true, speed = 1.1, spring = "easy" })
hl.animation({ leaf = "windowsMove", enabled = true, speed = 0.7, bezier = "quick" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 1.0, spring = "easy", style = "popin 98%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 0.9, bezier = "quick", style = "popin 98%" })
...
hl.animation({ leaf = "layersIn", enabled = true, speed = 0.9, bezier = "easeOutQuint", style = "fade" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 0.8, bezier = "quick", style = "fade" })
hl.animation({ leaf = "fadeLayersIn", enabled = true, speed = 0.8, bezier = "quick" })
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 0.8, bezier = "quick" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 1.0, bezier = "quick", style = "slide" })
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 0.9, bezier = "quick", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 0.9, bezier = "quick", style = "slide" })
...
hl.bind(
	"XF86MonBrightnessUp",
	hl.dsp.exec_cmd("swayosd-client --brightness +5 --min-brightness 2"),
	{ locked = true, repeating = true }
)
hl.bind(
...
hl.bind("F1", hl.dsp.exec_cmd("swayosd-client --output-volume mute-toggle"), { locked = true })
hl.bind(
	"F2",
	hl.dsp.exec_cmd("swayosd-client --output-volume -5 --max-volume 100"),
	{ locked = true, repeating = true }
